        ...
        try {
            ...
            for (Field f : fields) {
                ...
                if (searchAnnotationPresent) {
                    ...
                    boolean b = value instanceof String ? StringUtils.isNotBlank((String) value) : Objects.nonNull(value);
                    if (b) {
                        searchStructure(
                                type,
                                StringUtils.isNotBlank(search.name()) ? search.name() : CharSequenceUtil.toUnderlineCase(name)
                                , value
                        );
                    }
                }
