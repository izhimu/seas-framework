...
import com.izhimu.seas.base.config.LoginConfig;
import com.izhimu.seas.base.constant.SecurityConstant;
import com.izhimu.seas.base.dto.LoginDTO;
import com.izhimu.seas.base.exception.LoginException;
import com.izhimu.seas.base.exception.PwdErrorException;
import com.izhimu.seas.base.exception.VerifyCodeException;
...
public class CustomLoginFailureHandler implements AuthenticationFailureHandler {
    ...
    public CustomLoginFailureHandler(SysAccountLogService accountLogService, LoginHolder loginHolder, LoginConfig loginConfig) {
    ...
    public void onAuthenticationFailure(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, AuthenticationException e) {
        ...
        if (Objects.nonNull(status)) {
            accountLogService.saveLog(loginDTO, status);
        }
    }
}
